    ...
    <body style="background-color: rgb(255 211 211 / 80%);">
        ...
        <div class="container-fluid page-header mb-5">
            <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
                ...
                <br>
                <br>
                <h4 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">CONTACT</h4>
        ...
        <div class="container pt-5">
            ...
            <div class="row px-3 pb-2">
                ...
                <div class="col-sm-4 text-center mb-3">
                    ...
                    <p>Project2Group16@gmail.com</p>
                </div>
            </div>

            <div class="row">
                <div class="col-md-6 pb-5">
                    <iframe style="width: 100%; height: 392px;" src="https://goo.gl/maps/WPbsjiCfGeohLLrz9"
