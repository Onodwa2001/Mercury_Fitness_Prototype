...
Show text on image hover in Divi.

This plugin adds a new Module in your Divi Builder. The module allows you to add text on top of images. The text will appear and reveal itself when you hover an image.

There are three hover effects to reveal the text `Fade`, `Slide` and `Zoom`. You can set the transition duration for the overaly effect in the module settings. Also for the Slide Effect you can choose the direction for the Effect Top, Bottom, Left or Right. For a demo of plugin you can visit the link below.

[Divi Overlay Images Demo](https://www.learnhowwp.com/divi-overlay-images)

Getting started guide [How to add overlay text on image hover in Divi](https://www.learnhowwp.com/add-overlay-text-image-divi/)
...
* Option to Add an Icon
* Button Styles
* Icon Styles
**Price: $5.99** 

*Upgrade from withing your Dashboard after installing the free version of the plugin.*
...
== Installation ==
1. Upload `lwp-overlay-images.zip` to the `/wp-content/plugins/` directory
